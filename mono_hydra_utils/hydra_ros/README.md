...
#### Running with Learned Mono Hydra Semantics

This Mono Hydra workspace uses `mono_hydra_perception` for learned depth and
semantic labels. The standalone TensorRT segmentation runtime from upstream
Hydra is intentionally not included.
